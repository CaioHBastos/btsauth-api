...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
    private BtsfoodJwtKeyStore btsfoodJwtKeyStore;
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
        ...
        enhancerChain.setTokenEnhancers(List.of(
    ...
    public JwtAccessTokenConverter jwtAccessTokenConverter() {
        ...
        var jksResource = new ClassPathResource(btsfoodJwtKeyStore.getPath());
        var keyStorePass = btsfoodJwtKeyStore.getPass();
        var keyPairAlias = btsfoodJwtKeyStore.getAlias();
